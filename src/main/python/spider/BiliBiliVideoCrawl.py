...
# ---------------------------------------------
# @file BiliBiliVideoCrawl.py
# @description BiliBiliVideoCrawl
# @author WcJun
# @date 2021/01/02
# ---------------------------------------------
...
def main():
    bv: str = 'BV1RZ4y1N7ZP?from=search&seid=6315366300753223925'
    bilibili: BiliBiliVideo = BiliBiliVideo(bv)
    video_info: dict = bilibili.get_video_info()
    print(video_info)
    bilibili.download_video(video_info)
